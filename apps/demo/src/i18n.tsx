...
const messages: Record<DemoLocale, Record<MessageKey, string>> = {
  zh: {
    ...
    'home.cta': '立即体验',
    'home.stats.layoutEngine': '布局引擎',
    'home.stats.renderTarget': '渲染目标',
    'home.stats.editor': '编辑能力',
    'home.stats.export': '导出能力',
  ...
  en: {
    ...
    'home.intro':
      'Yoga Canvas lets you describe UI layout with data or JSX, then render, hit-test, select/highlight, zoom/pan, tweak via a properties panel, and export — all on Canvas. It is infrastructure for building editor experiences, not just a component collection.',
    'home.cta': 'Get Started',
    'home.stats.layoutEngine': 'Layout engine',
    'home.stats.renderTarget': 'Render targets',
    'home.stats.editor': 'Editing',
    'home.stats.export': 'Export',
